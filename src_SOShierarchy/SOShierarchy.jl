...
const SDPBody = SortedDict{Tuple{String, String, Exponent, Exponent}, SortedDict{Tuple{Exponent, Exponent}, Complex128}}
const SDPRhs = SortedDict{Tuple{Exponent, Exponent}, Complex128}
