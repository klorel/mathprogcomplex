...
# function create_vars!(element::T, bus::String, elemid::String, elem_formulation::Symbol, bus_vars::Dict{String, Variable}) where T <: MyType
#   return
# end

function create_vars!(element::T, link::Link, elemid::String, elem_formulation::Symbol, link_vars::Dict{String, Variable}, scenario::String) where T <: IIDMLine_π
...
function Sorig(element::T, link::Link, elemid::String, elem_formulation::Symbol, link_vars::Dict{String, Variable}) where T <: IIDMLine_π
  return link_vars["Volt_orig"] * conj(get_IorigMP(element, link_vars))
end

function Sdest(element::T, link::Link, elemid::String, elem_formulation::Symbol, link_vars::Dict{String, Variable}) where T <: IIDMLine_π
  return link_vars["Volt_dest"] * conj(get_IdestMP(element, link_vars))
end


## 3. Constraints creation
# function constraint(element::T, busid::String, elemid::String, elem_formulation::Symbol, bus_vars::Dict{String, Variable}) where T <: MyType
#   return [[], [], [], []]
# end
...
## 4. Measures
# function add_measure(element::T, busid::String, elemid::String, elem_formulation::Symbol, bus_vars::Dict{String, Variable}) where T
#   return Dict{String, Constraint}()
# end

function add_measure(element::T, link::Link, elemid::String, elem_formulation::Symbol, link_vars::Dict{String, Variable}) where T <: IIDMLine_π
  measure_equations = Dict{String, Constraint}()
...
## Utils functions
function get_IorigMP(element::IIDMLine_π, link_variables::Dict{String, Variable})
...
function get_IdestMP(element::IIDMLine_π, link_variables::Dict{String, Variable})
  rs = element.resistance
  xs = element.reactance
