...
function create_vars!(element::T, bus::String, elemid::String, elem_formulation::Symbol, bus_vars::SortedDict{String, Variable}, scenario::String) where T <: IIDMVolt
...
function constraint(element::T, busid::String, elemid::String, elem_formulation::Symbol, bus_vars::SortedDict{String, Variable}) where T <: IIDMVolt
  cstrname = "VOLTM_$busid"
  Vmin = element.minV
  Vmax = element.maxV
  nomV = element.nomV
  p = abs2(bus_vars["Volt"])
  return SortedDict{String, Constraint}(cstrname=> Vmin^2 << p << Vmax^2)
end
...
# ## 4. Measure accessor
# function add_measure(element::T, busid::String, elemid::String, elem_formulation::Symbol, bus_vars::SortedDict{String, Variable}) where T <: IIDMVolt
#   return SortedDict("V_$(busid)" => abs2((1/element.nomV)*bus_vars["Volt"]) ==  element.V)
# end
#
# # function add_measure(element::T, link::Link, elemid::String, elem_formulation::Symbol, link_vars::SortedDict{String, Variable}) where T
