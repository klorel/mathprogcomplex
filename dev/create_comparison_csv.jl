...
function create_csv_scaling(folder)
    ...
    f = open(joinpath("..", "knitro_runs","comparaisons_scaling_$folder"),"w")
    write(f, "Step 1 scaling 0;Step 2 scaling 0;Step 3 scaling 0;Step 1 scaling 1;Step 2 scaling 1;Step 3 scaling 1;Step 1 scaling 2;Step 2 scaling 2;Step 3 scaling 2;Step 1 scaling 3;Step 2 scaling 3;Step 3 scaling 3; Step 1 min; Step 2 min;Step 3 min ")

    for i in 1:size(csv1,1)
